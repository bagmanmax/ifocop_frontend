...
class Player {
  ...
  draw() {
   ...
   // ctx.fillRect(this.x, this.y, this.width, this.height);// rectangle for the hit box
     ...
     this.height*1.3); // draw the image of the bird*/

  }
  jump() {
    // making the bird jump with spacebar
    this.gravity -= 3;
     if (this.birdAnimation>=9){this.birdAnimation=1;}// this is the loop for the animation of the flappy bird adds 1 frame until 9 then it loops back again
